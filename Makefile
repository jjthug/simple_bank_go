...
migrateup:
	migrate -path db/migration -database "postgresql://root:3wT7Ntbtp4NbFdOeG2xJ@database-1.cg2wsl3fxdyt.ap-south-1.rds.amazonaws.com:5432/simple_bank" -verbose up
